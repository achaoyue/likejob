window.skins={};
...
})(eui.Skin);generateEUI.paths['resource/eui_skins/fankui/Feedback.exml'] = window.FeedbackSkin = (function (_super) {
	__extends(FeedbackSkin, _super);
	var FeedbackSkin$Skin6 = 	(function (_super) {
		__extends(FeedbackSkin$Skin6, _super);
		function FeedbackSkin$Skin6() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = FeedbackSkin$Skin6.prototype;
		...
		return FeedbackSkin$Skin6;
	})(eui.Skin);

	var FeedbackSkin$Skin7 = 	(function (_super) {
		__extends(FeedbackSkin$Skin7, _super);
		function FeedbackSkin$Skin7() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = FeedbackSkin$Skin7.prototype;
		...
		return FeedbackSkin$Skin7;
	})(eui.Skin);

	var FeedbackSkin$Skin8 = 	(function (_super) {
		__extends(FeedbackSkin$Skin8, _super);
		function FeedbackSkin$Skin8() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = FeedbackSkin$Skin8.prototype;
		...
		return FeedbackSkin$Skin8;
	})(eui.Skin);

	function FeedbackSkin() {
		_super.call(this);
		this.skinParts = ["phoneInput","btnSubmit","btnCancel","contentInput","btnClose","subLabel","resultGP"];
		
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this._Group1_i(),this._Group3_i(),this.resultGP_i()];
	}
	...
	_proto._Group3_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Label1_i(),this.phoneInput_i(),this._Label2_i(),this.btnSubmit_i(),this.btnCancel_i(),this._Scroller1_i(),this._Label3_i()];
		return t;
	};
	_proto._Label1_i = function () {
		var t = new eui.Label();
	...
	_proto._Group2_i = function () {
		...
		t.percentHeight = 100;
		t.percentWidth = 100;
		t.elementsContent = [this._Rect2_i(),this.contentInput_i()];
		return t;
	};
	_proto._Rect2_i = function () {
		var t = new eui.Rect();
		t.fillColor = 0xf7efef;
		t.percentHeight = 100;
		t.percentWidth = 100;
		t.x = 0;
		t.y = 0;
	...
	_proto.contentInput_i = function () {
		...
		t.multiline = true;
		t.prompt = "这里输入你的建议";
		t.promptColor = 0x3d3b3b;
		t.text = "";
		t.textColor = 0x1c0101;
		t.percentWidth = 100;
		t.x = 0.7;
		t.y = 0;
		return t;
	...
	_proto._Label3_i = function () {
		...
		t.anchorOffsetY = 0;
		t.height = 130;
		t.text = "非常感谢你的反馈，我们会根据你的反馈进行改进，一旦采用你的建议，我们现金酬谢。如果你有才能，也欢迎合作，特缺UI设计";
		t.width = 586;
		t.x = 26.99;
		t.y = 100;
		return t;
	};
	_proto.resultGP_i = function () {
		var t = new eui.Group();
		this.resultGP = t;
		t.anchorOffsetX = 0;
		t.height = 200;
		...
		t.x = 88;
		t.y = 442;
		t.elementsContent = [this._Rect3_i(),this._Rect4_i(),this.btnClose_i(),this.subLabel_i()];
		return t;
	};
	...
	_proto.btnClose_i = function () {
		...
		t.x = 331.73;
		t.y = 126;
		t.skinName = FeedbackSkin$Skin8;
		return t;
	};
	_proto.subLabel_i = function () {
		var t = new eui.Label();
		this.subLabel = t;
		t.text = "提交中。。。。";
		t.x = 22;
	...
	var GamePanelSkin$Skin9 = 	(function (_super) {
		__extends(GamePanelSkin$Skin9, _super);
		function GamePanelSkin$Skin9() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = GamePanelSkin$Skin9.prototype;
	...
	function GamePanelSkin() {
		...
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this._Group1_i(),this.bgGroup_i(),this._Group2_i(),this.waitGroup_i()];
	}
	...
	_proto._Group1_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.rect_i(),this._Image1_i(),this.vJoystick_i(),this.meScore_i(),this.oScore_i()];
		return t;
	};
	_proto.rect_i = function () {
		var t = new eui.Rect();
		this.rect = t;
		t.fillColor = 0xdefcdf;
		t.height = 1136;
		t.scaleX = 1;
		t.scaleY = 1;
	...
	_proto.bgGroup_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image2_i(),this._Image3_i(),this._Image4_i(),this._Image5_i(),this._Image6_i(),this._Image7_i(),this._Image8_i(),this._Image9_i()];
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
		t.source = "mountain_png";
		t.x = 277;
		t.y = 767.17;
		return t;
	};
	...
	_proto.btnFire_i = function () {
		...
		t.x = 40.34;
		t.y = 24;
		t.skinName = GamePanelSkin$Skin9;
		return t;
	};
	...
	return GamerUi;
})(eui.Skin);generateEUI.paths['resource/eui_skins/game/GiftSprite.exml'] = window.GiftSpriteSkin = (function (_super) {
	__extends(GiftSpriteSkin, _super);
	function GiftSpriteSkin() {
		_super.call(this);
		this.skinParts = ["img","light1","light2"];
		
		this.elementsContent = [this.img_i(),this.light1_i(),this.light2_i()];
	}
	var _proto = GiftSpriteSkin.prototype;
	...
	var GameAppSkin$Skin10 = 	(function (_super) {
		__extends(GameAppSkin$Skin10, _super);
		function GameAppSkin$Skin10() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = GameAppSkin$Skin10.prototype;
		...
		return GameAppSkin$Skin10;
	})(eui.Skin);

	function GameAppSkin() {
		_super.call(this);
		this.skinParts = ["btn_start","caidan","btnFankui","bg","headImg","beanImg","beanScore","btn_tixian","btn_congzhi","tabPanel"];
		
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this.bg_i(),this.headImg_i(),this.beanImg_i(),this.beanScore_i(),this.btn_tixian_i(),this.btn_congzhi_i(),this.tabPanel_i(),this._Image5_i(),this._Image6_i()];
	}
	...
	_proto.bg_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image1_i(),this._Image2_i(),this.btn_start_i(),this._Label1_i(),this._Image3_i(),this.caidan_i(),this.btnFankui_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	var HomeTabPanelSkin$Skin11 = 	(function (_super) {
		__extends(HomeTabPanelSkin$Skin11, _super);
		function HomeTabPanelSkin$Skin11() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = HomeTabPanelSkin$Skin11.prototype;
		...
		return HomeTabPanelSkin$Skin11;
	})(eui.Skin);

	var HomeTabPanelSkin$Skin12 = 	(function (_super) {
		__extends(HomeTabPanelSkin$Skin12, _super);
		function HomeTabPanelSkin$Skin12() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = HomeTabPanelSkin$Skin12.prototype;
		...
		return HomeTabPanelSkin$Skin12;
	})(eui.Skin);
	...
	_proto.btnRealTime_i = function () {
		...
		t.x = 90.37;
		t.y = -22.05;
		t.skinName = HomeTabPanelSkin$Skin11;
		return t;
	};
	_proto.btnMyHistory_i = function () {
		...
		t.x = 312;
		t.y = 16.5;
		t.skinName = HomeTabPanelSkin$Skin12;
		return t;
	};
